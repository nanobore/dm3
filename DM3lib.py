...
class DM3(object):
    ...
    def _readTagEntry(self):
        ...
        if ( debugLevel > 5):
            print(str(self._curGroupLevel)+"|"+self._makeGroupString()+":", end=' ')
        ...
        if isData:
            ...
            # it is a tag group
            self._curGroupNameAtLevelX[self._curGroupLevel+1] = str(tagLabel)
    ...
    def _readStructTypes(self):
        ...
        for i in range( nFields ):
            ...
            if ( debugLevel > 9 ):
                print(str(i) + "th namelength = " + str(nameLength))
