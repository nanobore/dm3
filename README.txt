...
nanobore is working on making it compatible with Python3.
...
This DM3 parser has only been tested on single-image files (i.e. not stacks) and not all data types are implemented yet.
